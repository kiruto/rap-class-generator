// Controller
function ensureUrl() {
    return document.URL.indexOf("workspace/myWorkspace.do") > 0;
}
...
var ClassGenUtil = {
    ...
    javaUtils: {
        ...
        jsonKey: function(key) {
            if ($ClassGen.JSON_ANNOTATION) {
                return $ClassGen.JSON_ANNOTATION.replace(/{{\$key}}/g, ClassGenUtil.utils.toUpperCase(key));
            } else {
        ...
        getClassStruct: function() {
            var importClass = "me.chunyu.g7json.annotation.JSONDict";
            if ($ClassGen.IMPORT_CLASS) {
                importClass = $ClassGen.IMPORT_CLASS;
            }
            return {
                deep: 0,
                imports: ["java.util.ArrayList", importClass],
        ...
        return {
            ...
            getOCClassDocument: function(classes, noteName, isRequest) {
                ...
                for (var i = 0; i < classes.length; i ++) {
                    builder
                        .append($ClassGen.annotations.interfaceStart)
                    ...
                    builder.newLine()
                        .append(template.end)
                        .append($ClassGen.annotations.interfaceEnd)
                        .newLine()
                        .append($ClassGen.annotations.implStart)
                        .append(this.parseImpl(classes[i], i, isRequest))
                        .append($ClassGen.annotations.implEnd);
                }
                return builder.output();
            },
            ...
            getOCDocument: function() {
                ...
                return $ClassGen.deleteAnnotations(request + response);
            },
